...
while running:
    ...
    AD = (constraint_rect.bottomleft[0] - dot_x, constraint_rect.bottomleft[1] - dot_y)
    CD = (constraint_rect.bottomright[0] - constraint_rect.bottomleft[0], constraint_rect.bottomright[1] - constraint_rect.bottomleft[1])
    ...
    pygame.draw.polygon(screen, (255, 0, 0), [(dot_x, dot_y), constraint_rect.bottomright, constraint_rect.bottomleft])
    ...
    screen.blit(font.render("Angle A Blue =", True, (255, 255, 255)), (constraint_rect.right + 20, constraint_rect.top + 20))
    screen.blit(font.render("Angle B Blue =", True, (255, 255, 255)), (constraint_rect.right + 20, constraint_rect.top + 50))
    screen.blit(font.render("Angle C Blue =", True, (255, 255, 255)), (constraint_rect.right + 20, constraint_rect.top + 80))
    screen.blit(font.render("Angle A Red =", True, (255, 255, 255)), (constraint_rect.right + 20, constraint_rect.top + 140))
    screen.blit(font.render("Angle D Red =", True, (255, 255, 255)), (constraint_rect.right + 20, constraint_rect.top + 170))
    screen.blit(font.render("Angle C Red =", True, (255, 255, 255)), (constraint_rect.right + 20, constraint_rect.top + 200))

    # Draw the angles
    screen.blit(font.render(str(angle_A_blue)+"°", True, (255, 255, 255)), (constraint_rect.right + 170, constraint_rect.top + 20))
    screen.blit(font.render(str(angle_B_blue)+"°", True, (255, 255, 255)), (constraint_rect.right + 170, constraint_rect.top + 50))
    screen.blit(font.render(str(angle_C_blue)+"°", True, (255, 255, 255)), (constraint_rect.right + 170, constraint_rect.top + 80))
    screen.blit(font.render(str(angle_A_red)+"°", True, (255, 255, 255)), (constraint_rect.right + 165, constraint_rect.top + 140))
    screen.blit(font.render(str(angle_D_red)+"°", True, (255, 255, 255)), (constraint_rect.right + 165, constraint_rect.top + 170))
    screen.blit(font.render(str(angle_C_red)+"°", True, (255, 255, 255)), (constraint_rect.right + 165, constraint_rect.top + 200))
